...
TODO:
1. При выставлении расписания нужно проверять, не занят ли преподватель на это время;
2. Предусмотреть перенос расписания с определнной даты на другой день недели;

TODO:
1. Выставить расписание для Базового семестра по схеме 12-21;	DONE
